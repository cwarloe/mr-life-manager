...
Thinking, not deliverables. Three areas:
...
| [`research/`](research/) | [customer problems](research/customer-problems.md) · [competitor notes](research/competitor-notes.md) |
...
[`planning/`](../planning/) holds the roadmap, backlog, and decision log.

**Reading order for someone new:** mission → principles → target audiences →
